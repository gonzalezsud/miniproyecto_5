                    ...
                    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                        ...
                        <form action="{{ route('maestros.update', $maestro->id) }}" method="POST">
                            ...
                            <div class="relative z-0 w-full mb-6 group">
                                ...
                                <input type="email" name="correo" id="correo" class="" placeholder="" required value="{{ $maestro->email }}"/>
                                </div>
                                <div class="relative z-0 w-full mb-6 group">
                                <label for="floating_nombre" class="">Nombre</label>
                                <input type="text" name="nombre" id="nombre" class="" placeholder=" " required value="{{ $maestro->nombre }}"/>
                            </div>
